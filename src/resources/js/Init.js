    ...
    return (
        ...
        (n.hexRGB = function (e, t) {
            ...
            if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
                return (
                    (e = [((e = "0x" + (e = 3 === (e = e.substring(1).split("")).length ? [e[0], e[0], e[1], e[1], e[2], e[2]] : e).join("")) >> 16) & 255, (e >> 8) & 255, 255 & e].join(",")),
                    1 <= t ? "rgba(" + e + ")" : "rgba(" + e + "," + t + ")"
                );
            ...
            l(e).exists() &&
                ...
                l(e).each(function () {
                    var e = l(this).data("date-format"),
                        e = { format: "" !== e ? e : "mm/dd/yyyy", maxViewMode: 2, clearBtn: !0, autoclose: !0, todayHighlight: !0, rtl: n.State.isRTL },
                        e = t ? d(e, t) : e;
                    l(this)
                        .datepicker(e)
        ...
        (n.Select2 = function (e, a) {
            l(e).exists() &&
                ...
                l(e).each(function () {
                    var e = l(this),
                        t = { placeholder: e.data("placeholder"), clear: e.data("clear"), search: e.data("search"), width: e.data("width"), theme: e.data("theme"), ui: e.data("ui") },
                        e =
