        ...
        <v-sheet rounded="md" width="360" elevation="10">
            ...
            <perfect-scrollbar style="height: calc(100vh - 240px); max-height: 240px">
                <v-list class="py-0 theme-list" lines="two">
                    <v-list-item v-for="item in []" :key="item.title" class="py-4 px-8 custom-text-primary" :to="item.href">
            ...
            <div class="px-8 py-3">
                <div class="bg-lightprimary rounded-md pa-5 overflow-hidden position-relative">
                    ...
                    <img src="" alt="bg-img" class="right-pos-img" />
                </div>
            </div>
            <div class="pt-4 pb-6 px-8 text-center">
                <v-btn color="primary" variant="outlined" block @click="'/'">Logout</v-btn>
            </div>
        </v-sheet>
    </v-menu>
</template>
